...
function App() {
  return (
    <div className="App">
   <Article title="Find your dream job as a developer"
    content="If you are like most software engineers, web developers, or app developers 
    ...
    In my experience, software developers generally draw a hard line between 'doing' or 'building'
     ...
     Positioning
     Consider a billboard. Positioning refers not only to its physical location, but also its content -- as it relates to the audience. For a commercial, positioning relates to everything from its channel, time of day, region, show, as well as its content and audience.
     ...
     " 
     url="https://images.pexels.com/photos/577585/pexels-photo-577585.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"/>
    </div>
  );
}
